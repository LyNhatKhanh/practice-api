...
public class GlobalExceptionHandler {
    ...
    private String mapAttribute (String rawMessage, Map<String, Object> attributes) {
        String minValue = String.valueOf(attributes.get(ATTRIBUTE_MIN));

        return rawMessage.replace("{" + ATTRIBUTE_MIN + "}", minValue);
    }
